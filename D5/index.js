...
*/
let Me = { name: 'Abbos', age: 4, skills:[] }
/* Ex.E 
...
const Dice = function() {
    ...
    if(random > 1 && random < 6) {
        return random
    }else return 'number is not between 1 and 6'
}
...
const onlyLetters = function(str) {
    let onlyString = str.replace(/\d+/g, '')
    let onlyString2 = str.replace(/[0-9]/g, '')
    return onlyString2.replace('  ', ' ')
}
console.log(onlyLetters("I love 123 coding"))
